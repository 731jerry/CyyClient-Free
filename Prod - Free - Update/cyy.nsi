...
!define VERSION_NAME "基础版"
!define PRODUCT_VERSION "2.1.33"
...
Section -Post
  ...
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayVersionFree" "${PRODUCT_VERSION}"
  ...
  WriteRegStr HKCU "${PRODUCT_UNINST_KEY}" "VersionNameFree" "${VERSION_NAME}"
  WriteRegStr HKCU "${PRODUCT_UNINST_KEY}" "DisplayVersionFree" "${PRODUCT_VERSION}"
