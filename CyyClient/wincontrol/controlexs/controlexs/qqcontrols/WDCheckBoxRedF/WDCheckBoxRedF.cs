...
{
    public partial class WDCheckBoxRedF : CheckBox
    {
        /*
         * 设置
        ...
        private Size bigSize = new Size(45, 15);
        ...
        public WDCheckBoxRedF(IContainer container)
        {
            //container.Add(this);
            //InitializeComponent();
        }
            ...
            */
            ...
            switch (_state)
            {
                case QQControlState.Highlight:
                    ...
                    g.FillRectangle(new SolidBrush(Color.Red), 0, 0, textRect.Width, textRect.Height);
                ...
                default:
                    //g.FillEllipse(new SolidBrush(Color.FromArgb(245, 245, 230)), 0, 0, textRect.Width, textRect.Height);
                    //g.FillRectangle(new SolidBrush(Color.FromArgb(245, 245, 230)), 0, 0, textRect.Width, textRect.Height);
                    g.FillRectangle(new SolidBrush(Color.White), 0, 0, textRect.Width, textRect.Height);
            ...
            if (Checked)
            {
                ...
                g.FillRectangle(Brushes.Red, 0, 0, textRect.Width, textRect.Height);
            }
