...
{
    public partial class WDCheckBoxGrayF : CheckBox
    {
        /*
         * 设置
        ...
        public WDCheckBoxGrayF(IContainer container)
        {
            //container.Add(this);
            //InitializeComponent();
        }
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            switch (_state)
            {
                case QQControlState.Highlight:
                    ...
                    g.FillRectangle(new SolidBrush(Color.FromArgb(96,96,96)), 0, 0, textRect.Width, textRect.Height);
            ...
            /*
            ForeColor = (Checked) ? Color.White : Color.Red;
